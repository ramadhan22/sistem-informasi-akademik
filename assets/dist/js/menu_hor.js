...
$(window).load(function() {
  $("#cssmenu_hor").menumaker({
    title: "Menu",
    format: "dropdown"
  });


$('#cssmenu_hor').prepend("<div id='menu-indicator'></div>");

var foundActive = false, activeElement, indicatorPosition, indicator = $('#cssmenu_hor #menu-indicator'), defaultPosition;

$("#cssmenu_hor > ul > li").each(function() {
...
if (foundActive === false) {
  activeElement = $("#cssmenu_hor > ul > li").first();
}
...
$("#cssmenu_hor > ul > li").hover(function() {
  activeElement = $(this);
